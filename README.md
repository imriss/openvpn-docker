...
#### This is a fork of the docker image used by the kubernetes helm chart openvpn: [https://github.com/kubernetes/charts/tree/master/stable/openvpn](https://github.com/kubernetes/charts/tree/master/stable/openvpn).
...
```bash
	...
	git clone https://github.com/imriss/openvpn-docker.git
	cd openvpn-docker
	docker build -t imriss/openvpn-docker:$(cat VERSION) .
